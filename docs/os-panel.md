...
- **AI provider**: Anthropic Claude, OpenAI (ChatGPT), Google Gemini, xAI Grok, DeepSeek, Qwen, Mistral, NVIDIA NIM, Groq, Together, OpenRouter, Ollama / LM Studio (local, key optional) or any custom OpenAI-compatible endpoint; model, endpoint and key.
