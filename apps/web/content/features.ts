...
export const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    icon: "plug",
    accent: "green",
    highlights: ["Configurable Apify Actors per purpose", "Meta OAuth, signed webhooks, delivery receipts", "Chrome MV3 extension with step-by-step verification"],
    steps: ["Add your Apify token in Settings.", "Connect Meta Pages in Settings.", "Pair the extension from Settings > Automation."],
    doc: "integrations",
  },
  {
    slug: "security",
