...
3. Invite colleagues later from **Settings → Account** (roles: Owner, Admin, Member). If you belong to several workspaces you switch between them there too.
...
## Services (activated for you)

Lead discovery, enrichment and the AI agent are technical services that the CNEX AI team sets up and maintains for your workspace; you never handle API keys or provider settings. **Settings → Automation → Services** shows what is active. If something shows *Not active*, email info@cnexai.com or WhatsApp +92 312 7233047 and it will be switched on.

Two things you connect yourself, because they are your own accounts:
...
**Settings → Messaging → Mode** (the AI must be active for your workspace, see *Services* above):
